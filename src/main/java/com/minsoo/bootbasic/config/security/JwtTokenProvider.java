package com.minsoo.bootbasic.config.security;
...
public class JwtTokenProvider {
    ...
    public String createToken(String userUid , List<String> roles) {
        ...
        log.info("[createToken] 토근 생성 완료");
        return token;
    }

    //3. 인증이 성공했을 때 SecurityContextHolder에 저장할 Authentication 생성
